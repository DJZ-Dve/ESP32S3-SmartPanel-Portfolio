...
const LV_ATTRIBUTE_MEM_ALIGN uint8_t ui_img_icon_lang_data[] = {
...
const lv_img_dsc_t ui_img_icon_lang = {
    .header.always_zero = 0,
    .header.w = 20,
    .header.h = 20,
    .data_size = sizeof(ui_img_icon_lang_data),
    .header.cf = LV_IMG_CF_TRUE_COLOR_ALPHA,
    .data = ui_img_icon_lang_data
};